...
def tegn_fugl(x, y):
    pygame.draw.rect(vindu, (255, 0, 0), (x, y, fugl_BREDDE, fugl_HOYDE))

def tegn_rør(x, høyde):
    pygame.draw.rect(vindu, (0, 255, 0), (x, 0, rør_bredde, høyde))
    pygame.draw.rect(vindu, (0, 255, 0), (x, høyde + 150, rør_bredde, HOYDE - høyde - 150))
